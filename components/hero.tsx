...
export default function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center text-center min-h-[85vh] px-6 bg-gradient-to-b from-[#0a0a0f] to-[#1a1530] text-white overflow-hidden">
