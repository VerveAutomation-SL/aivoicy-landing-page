...
export default function ModesSection() {
    return (
        <section
            id="modes"
            className="py-24 px-6 bg-gradient-to-b from-[#1a1530] via-[#141425] to-[#0a0a0f] text-white text-center"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="group relative p-8 bg-[#1a1a24] rounded-xl border border-gray-800 hover:border-indigo-500/40 hover:shadow-[0_0_30px_rgba(99,102,241,0.2)] transition-all duration-300">
                        ...
                        <ul className="text-gray-300 text-sm space-y-2 mb-6">
                            ...
                            <li className="flex items-center justify-center gap-2">
                                <Languages size={16} className="text-indigo-400" /> Multi-language voice translation
                            </li>
                            <li className="flex items-center justify-center gap-2">
